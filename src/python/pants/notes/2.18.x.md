...
* Bump generic-array from 0.14.5 to 0.14.6 in /src/rust/engine ([#16405](https://github.com/pantsbuild/pants/pull/16405))

* Bump serde_test from 1.0.137 to 1.0.143 in /src/rust/engine ([#16463](https://github.com/pantsbuild/pants/pull/16463))

* Use a list of requirement constraints for lockfile invalidation ([#16469](https://github.com/pantsbuild/pants/pull/16469))

* Refactor `build_pex` rule with `@rule_helper` ([#16465](https://github.com/pantsbuild/pants/pull/16465))
...
* Add `PexRequirements.req_strings_from_requirement_fields()` ([#16460](https://github.com/pantsbuild/pants/pull/16460))

* Add `__default__` symbol to `[python].resolves_to_constraints_file` ([#16452](https://github.com/pantsbuild/pants/pull/16452))

* Add IBM to user list. ([#16457](https://github.com/pantsbuild/pants/pull/16457))

* Build macos10.15 wheels for all 3 pythons. ([#16453](https://github.com/pantsbuild/pants/pull/16453))
...
* [internal] Shell completions fix for Bash ([#16442](https://github.com/pantsbuild/pants/pull/16442))

* [internal] Amend missing `timeout` field in target generators ([#16387](https://github.com/pantsbuild/pants/pull/16387))

* Add `[python].resolves_to_constraints_file` ([#16420](https://github.com/pantsbuild/pants/pull/16420))

* Support macOS-10.15 CI on a self-hosted runner. ([#16440](https://github.com/pantsbuild/pants/pull/16440))

* Fix `--process-cleanup` deprecation. ([#16447](https://github.com/pantsbuild/pants/pull/16447))

* go: add debug goal to show package analysis ([#16429](https://github.com/pantsbuild/pants/pull/16429))

* Allow backend packages to also register remote auth plugins ([#16444](https://github.com/pantsbuild/pants/pull/16444))

* Bump release requirements to macos 11.0 ([#16436](https://github.com/pantsbuild/pants/pull/16436))

* Fix `CacheContentBehavior::Defer` with a remote cache ([#16439](https://github.com/pantsbuild/pants/pull/16439))

* Use our temporary_dir util in _release_helper.py. ([#16435](https://github.com/pantsbuild/pants/pull/16435))
