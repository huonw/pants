...
## 2.18.0a0 (Jun 23, 2023)

### Uncategorized

* Bump url from 2.3.1 to 2.4.0 in /src/rust/engine ([#19265](https://github.com/pantsbuild/pants/pull/19265))

* Fix pytest-cov validation check. ([#19366](https://github.com/pantsbuild/pants/pull/19366))

* A script to generate a release announcement message. ([#19361](https://github.com/pantsbuild/pants/pull/19361))

* Run the deploy_to_s3.py script via Pants. ([#19360](https://github.com/pantsbuild/pants/pull/19360))
...
* add module mapping for launchdarkly-server-sdk ([#19355](https://github.com/pantsbuild/pants/pull/19355))
